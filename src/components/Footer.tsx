    ...
    >
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <motion.div variants={staggerChild}>
            ...
            <p className="opacity-60 text-xs lg:text-sm leading-relaxed max-w-xs mb-6">
              Refining the art of living through sustainable, minimalist design. Based in
              Hyderabad, serving clients nationwide.
            </p>
        ...
        <motion.div
          ...
          animate={footer.inView ? 'visible' : 'hidden'}
        >
          <p>© 2025 Progressive Interiors. All rights reserved.</p>
